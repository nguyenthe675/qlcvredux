                    ...
                    <li className="dropdown notification-menu">
                        ...
                        <ul className="dropdown-menu">
                            ...
                            <li className="bell-notification">
                                <a className="media">
                                    <span className="media-left media-icon">
                                        <img className="img-circle" src="assets/images/avatar-1.png" alt={ "Ảnh đại diện" }/>
                                    </span>
                            ...
                            <li className="bell-notification">
                                <a className="media">
                                    <span className="media-left media-icon">
                                        <img className="img-circle" src="assets/images/avatar-2.png" alt="Ảnh đại diện"/>
                                    </span>
                            ...
                            <li className="bell-notification">
                                <a className="media"><span className="media-left media-icon">
                                        <img className="img-circle" src="assets/images/avatar-3.png" alt="Ảnh đại diện"/>
                                    </span>
